...
import { useCreateReviewMutation } from '../store';
...
export default function AddReviewOverlay({ student, course, open, onClose }) {
	const [createReview, results] = useCreateReviewMutation();
	...
	const handleCreateReviewSubmit = (e) => {
		e.preventDefault();
		createReview({ student: student, course: course._id, ...courseReview });
	};
